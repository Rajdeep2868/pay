    ...
    <div className="min-h-screen flex items-center justify-center bg-background">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-foreground/70">Sign in to access your crypto payment dashboard</p>
        </div>
        
        <motion.button
          onClick={signIn}
          className="w-full py-3 px-4 flex items-center justify-center gap-3 bg-white text-gray-800 rounded-lg font-medium transition-all hover:shadow-md"
          whileHover={{ y: -3 }}
          whileTap={{ scale: 0.98 }}
        >
